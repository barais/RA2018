...
\newcommand{\bestcite}[1]{\cite{#1}} 
%µ\newcommand{\XMLaddatt*}[2]{}
...
\pers{Benoit}{Baudry}{CollaborateurExterieur}[KTH][Habilite]
%\end{composition}
...
%In the next two years this research will be supported by the InfraJVM project.
...
Paper \bestcite{coulon:hal-01889155} was awarded the best vision paper at SLE'18. \\
Paper \bestcite{leduc:hal-01890446} was awarded the best artefact associated to a scientific paper at SLE'18. 

Paper \bestcite{bruel:hal-01910113} was awarded the best paper at ICMT'18.
...
\subsubsection*{Obeo}
\begin{itemize}
	\item Partners: Inria/Obo
	\item Dates: 2017-2020
	\item Abstract: Web engineering for domain-specific modeling languages, Fabien Coulon's PhD Cifre project.	 
\end{itemize}


\subsubsection*{OKWind}
\begin{itemize}
	\item Partners: UR1/OKWind
	\item Dates: 2017-2020
	\item Abstract: Models@runtime to improve self-consumption of renewable energies, Alexandre Rio's PhD Cifre project.	 .	 
\end{itemize}
...
\begin{itemize}
	...
	\item Abstract: Security level modelling of user interface, Youssou Ndiaye's PhD Cifre project.	 .	 
\end{itemize}


\subsubsection*{Keolis}
\begin{itemize}
	\item Partners: UR1/Keolis
	\item Dates: 2018-2021
	\item Abstract: Urban mobility: machine learning for building simulators using large amounts of data, Gauthier LYAN's PhD Cifre project.	 .	 
\end{itemize}


\subsubsection*{FaberNovel}
\begin{itemize}
	\item Partners: UR1/FaberNovel
	\item Dates: 2018-2021
	\item Abstract: Abstractions for linked data and the programmable web,  Antoine Cheron's PhD Cifre project.	 .	 
\end{itemize}
...
%\XMLaddatt*{type}{sanspuces}
        \item Program: EIT Digital
        \item Project acronym: UAV-Retina
        \item Project title: Unmanned Aerial Vehicles - Retina
        \item Duration: from 2018-10 to 2019-12
        \item Coordinator: UR1
		\item Other partners: Bright Cape (company from the Netherlands), FBK (Trento University, Italy), 
		JCP Connect (company from France), Tellus Environment (company from France), Fire Department of Ille et Vilaine (France), Fire Department of Trento (Italy)
        \item Abstract:  The UAV-Retina objectives aims at the creation of s startup company for a flexible autonomous drone
		platform for search and rescue, using advanced unmanned vehicles and data analytics. The markets for the company will be
		Improved Explosive Devices detection, support for firefighting operations, and support for avalanche search and rescue operations.
\end{itemize}
...
Benoit Baudry:
    \begin{itemize}
    	\item Associate Editor in Chief of STVR
    	\item Associate Editor in Chief of SOSYM
    \end{itemize}
    , 
...
Benoit Baudry organized a  dagstuhl-Seminar on the relationship between DevOps and quality assurance from a software engineering perspective \url{https://www.dagstuhl.de/de/programm/kalender/semhp/?semnr=18122}.
...
\item PhD in progress: Alexandre Rio, \emph{Demand Side Management A model driven approach to promote energy self-consumption }, 2016, O. Barais, Y. Maurel
...
\paragraph*{Benoit Baudry} was in the examination committee of the following PhD thesis: 
\begin{itemize}
	\item Hugo Brunelière (IMT), Dec 2018, Reviewer
	\item Johanna Binti Ahmad (Univ. Putra Malaysia), 2018, Reviewer
	\item Daniel Schoepe (Chalmers),  2018, Reviewer
\end{itemize}
